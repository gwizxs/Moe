### Данный проект представляет собой аналог севрисов для просмотра медиа контентов со всеми ее базовыми функциями, ниже можно узнать архитектуру проекта и узнать некоторые подходы для своих проектов
